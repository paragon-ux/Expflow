...
| DS-C-SEMANTIC-TRUST    | C           | Authority-source trust defaults and local versus remote semantic profiles.               | Sources never become accepted authority without immutable decisions.                            |
