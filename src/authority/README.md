...
Authority records are validated before immutable writes. Current-source projection replays source-registration decisions in durable write order and accounts for accepted decisions, revocation/rejection/supersession, source supersession chains, and effective intervals.
