...
Expflow `v1.1.0` proves the material core, but it does not yet provide a complete ordinary decision surface. The current four-command CLI can initialize a project, record complete material-tree revisions, report drift, and restore recorded node or tree state as a new forward revision. Independent `v1.1.0` testing also confirms several usability and safety limits that Build Week Phase 1 must correct:
...
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Expflow  | Portable workflow VCS across material and non-material artifact histories, scoped authority, decisions, restoration, and reuse.                             | Public v1.1.0 material CLI and tested advanced runtimes exist; the approachable GUI, broad evidence intake, portability round trip, and empirical pilots remain to be completed. |
