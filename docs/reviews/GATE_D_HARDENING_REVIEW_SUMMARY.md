...
The hardening review focused on native Expflow durability and recovery behavior, not adapter integration work. The release branch incorporates the Gate D native hardening closure before the v1.0.0 release candidate.
