...
| -------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Expflow  | Public v1.0.1 CLI, immutable material runtime, advanced TypeScript record-family runtimes, packaging, recovery, and local conformance evidence. | User-facing advanced queries, broad evidence intake, portable round trip, large pilots, GUI, and empirical evaluation. |
