...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Expflow  | Public v1.2.1 CLI, local GUI, application command service, immutable material runtime, advanced TypeScript record-family runtimes, packaging, recovery, and local conformance evidence. | User-facing advanced queries, broad evidence intake, portable round trip, large pilots, and empirical evaluation. |
