...
**Status:** Build Week active documentation navigation.
...
External product narrative lives in:

- `docs/external/overviews/`
- `docs/external/narratives/`

Build Week package provenance lives in:
